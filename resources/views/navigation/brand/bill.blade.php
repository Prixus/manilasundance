...
<div class="container-fluid">
    <div class="row">
      ...
      <button style = "background-color:#337ab7;float:right;" type="button" class="btn btn-primary" aria-pressed="false"><a href = "/brand/seepdf/{{$ReservationAccountBrandInformations->PK_ReservationID}}" target="_blank" >Print</a></button>
      @endif
