            ...
            <table id="PenaltiesTable" class="table table-striped">
              ...
              <tbody>
                ...
                <tr id='Penalty{{$Penalty->PK_PenaltyID}}'>
					          ...
					          <td>
                        <button id="btnDelete" style = 'background-color:red;' type='button' class='btn btn-primary' data-toggle='button' aria-pressed='false' data-id='{{$Penalty->PK_PenaltyID}}' data-name='{{$Penalty->Penalty_Name}}' data-description='{{$Penalty->Penalty_Description}}'>Delete</button>
                        <button id="btnEdit" style = 'background-color:green;margin-right:5px;' type='button' class='btn btn-primary' data-id='{{$Penalty->PK_PenaltyID}}' data-name='{{$Penalty->Penalty_Name}}' data-description='{{$Penalty->Penalty_Description}}'>Edit</button>
                    </td>
                </tr>
                @endforeach
