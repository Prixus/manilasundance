          ...
          <th></th>
              ...
              <tbody>
                ...
                <tr id = "bazaar{{$bazaar->PK_BazaarID}}">
                  ...
                  <td>{{$bazaar->Bazaar_BookingCost}}</td>
        					<td><button id="BtnEdit"    style = "background-color:green;float:left;"  class="btn btn-primary"  aria-pressed="false" data-id="{{$bazaar->PK_BazaarID}}" data-name="{{$bazaar->Bazaar_Name}}" data-startdate="{{$bazaar->Bazaar_DateStart}}" data-enddate = "{{$bazaar->Bazaar_DateEnd}}" data-starttime="{{$bazaar->Bazaar_TimeStart}}" data-endtime= "{{$bazaar->Bazaar_TimeEnd}}" data-end="{{$bazaar->Bazaar_DateTimeEnd}}" data-venue="{{$bazaar->Bazaar_Venue}}" data-status="{{$bazaar->Bazaar_Status}}" data-bookingcost="{{$bazaar->Bazaar_BookingCost}}">Edit</button></td>
                  <td><button id="BtnDelete" style = "background-color:red;float:right;"   class="btn btn-primary" aria-pressed="false" data-id="{{$bazaar->PK_BazaarID}}" data-name="{{$bazaar->Bazaar_Name}}" data-startdate="{{$bazaar->Bazaar_DateStart}}" data-enddate = "{{$bazaar->Bazaar_DateEnd}}" data-starttime="{{$bazaar->Bazaar_TimeStart}}" data-endtime= "$bazaar->Bazaar_TimeEnd" data-venue="{{$bazaar->Bazaar_Venue}}" data-status="{{$bazaar->Bazaar_Status}}" data-bookingcost="{{$bazaar->Bazaar_BookingCost}}">Delete</button></td>
              ...
              <button type="button" class = "close" data-dismiss ="modal"> &times;</button>
                  ...
                  <div class="modal-body">
                      ...
                      <div class="form-group">
                        ...
                        {{Form::text('Bazaar_Venue',null,array('placeholder'=>'Enter Bazaar Venue','required'=>'required'))}}
                      </div>
                      <div class = "form-group">
                        <label> Bazaar Booking Cost: </label>
                        {{Form::number('Bazaar_BookingCost',null,array('step'=>'0.01','min'=>'1'))}}

                      </div>
                      <div class = "form-group">
                        <label> Bazaar Stall Map: </label>
                        {{Form::file('Bazaar_StallMap')}}
                      </div>
                      <div class = "form-group">
