...
@if((request()->segment(1)=='brand' AND request()->segment(2)=='settings') OR (request()->segment(1)=='admin' AND request()->segment(2)=='brandprofile'))
...
@if(request()->segment(1)=='admin' AND request()->segment(2)=='reportform')
<link href='/css/accountsettings.css' rel='stylesheet' />
@endif
...
<!-- @if(request()->segment(1)=='brand' AND request()->segment(2)=='stalls')
