...
<div class="user-panel">
				...
				<img href = "/" src="/img/users/user2-160x160.jpg" class="img-circle" alt="User Image">
				</div>
      ...
      <li <?php if(request()->segment(1)=='admin' AND request()->segment(2)=='dashboard'): ?> class="active" <?php endif; ?> ><a href="/admin/dashboard">Dashboard</a></li>
      <li <?php if(request()->segment(1)=='admin' AND request()->segment(2)=='accounts'): ?> class="active" <?php endif; ?> ><a href="/admin/accounts">Accounts</a></li>
