    ...
    <div class="row">
      ...
      <div>
        <?php if($ReservationAccountBrandInformations->Billing_Status != "Void"): ?>
            <button style = "background-color:#337ab7;float:right;" type="button" class="btn btn-primary" aria-pressed="false"><a href = "/admin/seepdf/<?php echo e($ReservationAccountBrandInformations->PK_ReservationID); ?>" target="_blank">Print</a></button>
        <?php endif; ?>
