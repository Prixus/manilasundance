    ...
    <label style="margin-left:10px;width:150px;display:inline-block;font-weight:normal;">Show Password</label><br><br>
      <!-- start profilepicture dessa 2018-0909 -->
        ...
        <h5 class="perrow"><div class="lbl">Current Profile Photo:</div>
          ...
          <br><img onerror="this.src='/img/users/profilepicture.jpg'"  src="/<?php echo e($Info->Account_ProfilePicture); ?>" class="img-circle" style="margin-left:30%;width:10%;height:10%;" alt="User Image"><br><br>
        ...
        <h5 class="perrow"><div class="lbl">Current Balance:</div>    <input class="txtbox" type="text" value="<?php echo e($Info->Account_Balance); ?>" disabled></h5>
