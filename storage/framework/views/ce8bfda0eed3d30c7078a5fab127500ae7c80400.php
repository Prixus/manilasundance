          ...
          <th>Cost</th>
              ...
              <tbody>
                ...
                <tr id='Penalty<?php echo e($Penalty->PK_PenaltyID); ?>'>
                        ...
                        <td><?php echo e($Penalty->Penalty_Cost); ?></td>
					          <td>
                        <button id="btnDelete" style = 'background-color:red;' type='button' class='btn btn-primary' data-toggle='button' aria-pressed='false' data-id='<?php echo e($Penalty->PK_PenaltyID); ?>' data-name='<?php echo e($Penalty->Penalty_Name); ?>' data-description='<?php echo e($Penalty->Penalty_Description); ?>' data-cost='<?php echo e($Penalty->Penalty_Cost); ?>'>Delete</button>
                        <button id="btnEdit" style = 'background-color:green;margin-right:5px;' type='button' class='btn btn-primary' data-id='<?php echo e($Penalty->PK_PenaltyID); ?>' data-name='<?php echo e($Penalty->Penalty_Name); ?>' data-description='<?php echo e($Penalty->Penalty_Description); ?>' data-cost='<?php echo e($Penalty->Penalty_Cost); ?>'>Edit</button>
                    </td>
                </tr>
