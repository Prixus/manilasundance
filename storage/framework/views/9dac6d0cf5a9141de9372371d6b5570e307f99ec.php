      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse container">
          ...
          <ul class="nav navbar-nav navbar-left">
            ...
            <li class="dropdown" <?php if(request()->segment(1)=='brands'): ?> class="dropdown active" <?php endif; ?> ><a href="/brands" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" >BRANDS<span class="caret"></span></a>
