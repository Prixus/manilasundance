...
<!-- End Dessa 2018-0829 -->
      ...
      <div id="newpayments" class="collapse in">
          ...
          <div class="table-responsive">
            ...
            <td>
				  <button style = "background-color:green;float:right;" type="button" class="btn btn-primary" aria-pressed="false"><a href = "/admin/bill/<?php echo e($payment->FK_BillingID); ?>">Show Bill</button></td>
                </tr>
      ...
      <div id="approved" class="collapse in">
          ...
          <div class="table-responsive">
            <table class="table table-striped classapproved" id="approved">
              ...
              <?php $__currentLoopData = $approvedPayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $approvedPayment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr id="Payment<?php echo e($approvedPayment->PK_PaymentID); ?>">
                  <td><?php echo e($approvedPayment->PK_PaymentID); ?></td>
                  <td><?php echo e($approvedPayment->FK_BillingID); ?></td>
                  <!-- <td><?php echo e($approvedPayment->Payment_Deadline); ?></td> -->
                  <td><?php echo e($approvedPayment->Payment_DateTime); ?></td>
                  <td><?php echo e($approvedPayment->Payment_Amount); ?></td>
                  <td><?php echo e($approvedPayment->Payment_AccountNumber); ?></td>
                  <td><?php echo e($approvedPayment->Payment_Status); ?></td>

          <td>
          <button style = "background-color:green;float:right;" type="button" class="btn btn-primary" aria-pressed="false"><a href = "/admin/bill/<?php echo e($approvedPayment->FK_BillingID); ?>">Show Bill</button></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
