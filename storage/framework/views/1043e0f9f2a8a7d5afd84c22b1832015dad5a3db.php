          ...
          <button type="button" class = "close" data-dismiss ="modal"> &times;</button>
              ...
              <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <?php echo e(Form::number('BillID',null,array('id'=>'billid','required'=>'required', 'readonly' =>'readonly', 'class'=>'form-control'))); ?>

                  </div>
                  <div class="form-group">
                    <label> Payment Reference Number: </label>
                    <?php echo e(Form::text('AccountNumber',null, array('required'=>'required', 'id'=>'AccountNumber', 'class'=>'form-control', 'maxlength'=>'15'))); ?>

                  </div>
                  <div class="form-group">
                    <label> Payment Amount: </label>
                    <?php echo e(Form::number('PaymentAmount',null,array('id'=>'billid','required'=>'required', 'min' => 1, 'class'=>'form-control'))); ?>
