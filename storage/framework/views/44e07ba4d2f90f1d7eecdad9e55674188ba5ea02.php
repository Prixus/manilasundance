            ...
            <table class="table table-striped" id="AdminBillingTable">
              ...
              <?php $__currentLoopData = $bills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Bill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  ...
                  <?php if($Bill->Billing_BalanceFromPreviousBilling < 0): ?>
                  <td>(<?php echo e($Bill->Billing_BalanceFromPreviousBilling * -1); ?>)</td>
                  <?php else: ?>
                  <td><?php echo e($Bill->Billing_BalanceFromPreviousBilling); ?></td>
                  <?php endif; ?>
                  <td><?php echo e($Bill->Billing_AmountToBePaid); ?></td>
                  <td><?php echo e($Bill->created_at); ?></td>
                  <td><?php echo e($Bill->Billing_Status); ?></td>
                  <td><button style = "background-color:#337ab7;float:right;" type="button" class="btn btn-primary" aria-pressed="false"><a href = "/admin/bill/<?php echo e($Bill->PK_BillingID); ?>" >Show Bill</a></button></td>
                </tr>
