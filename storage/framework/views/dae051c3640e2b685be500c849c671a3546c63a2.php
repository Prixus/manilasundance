...
<div class="container-fluid">
              ...
              <tbody>
                ...
                <tr id = "bazaar<?php echo e($bazaar->PK_BazaarID); ?>">
                  ...
                  <td><?php echo e($bazaar->Bazaar_Status); ?></td>
        					<td><button id="BtnEdit"    style = "background-color:green;float:left;"  class="btn btn-primary"  aria-pressed="false" data-description="<?php echo e($bazaar->Bazaar_Description); ?>" data-id="<?php echo e($bazaar->PK_BazaarID); ?>" data-name="<?php echo e($bazaar->Bazaar_Name); ?>" data-startdate="<?php echo e($bazaar->Bazaar_DateStart); ?>" data-enddate = "<?php echo e($bazaar->Bazaar_DateEnd); ?>" data-starttime="<?php echo e($bazaar->Bazaar_TimeStart); ?>" data-endtime= "<?php echo e($bazaar->Bazaar_TimeEnd); ?>"  data-venue="<?php echo e($bazaar->Bazaar_Venue); ?>" data-status="<?php echo e($bazaar->Bazaar_Status); ?>" >Edit</button></td>
                  <td><button id="BtnDelete" style = "background-color:red;float:right;"   class="btn btn-primary" aria-pressed="false" data-description="<?php echo e($bazaar->Bazaar_Description); ?>" data-id="<?php echo e($bazaar->PK_BazaarID); ?>" data-name="<?php echo e($bazaar->Bazaar_Name); ?>" data-startdate="<?php echo e($bazaar->Bazaar_DateStart); ?>" data-enddate = "<?php echo e($bazaar->Bazaar_DateEnd); ?>" data-starttime="<?php echo e($bazaar->Bazaar_TimeStart); ?>" data-endtime= "<?php echo e($bazaar->Bazaar_TimeEnd); ?>" data-venue="<?php echo e($bazaar->Bazaar_Venue); ?>" data-status="<?php echo e($bazaar->Bazaar_Status); ?>">Cancel Bazaar</button></td>
                  <td><button style = "background-color:#337ab7;float:right;" type="button" class="btn btn-primary"><a href = "/admin/manage_stalls/<?php echo e($bazaar->PK_BazaarID); ?>" >Monitor Stalls</a></button></td>
                </tr>
              ...
              <button type="button" class = "close" data-dismiss ="modal"> &times;</button>
                  ...
                  <div class="modal-body">
                      ...
                      <div class = "form-group">
                        ...
                        <?php echo e(Form::text('Bazaar_Name',null,array('placeholder'=>'Enter Bazaar Name','required'=>'required', 'class'=>'form-control'))); ?>

                      </div>
                      <div class = "form-group">
                        <label> BAZAAR STARTING DATE: </label>
                        <?php echo e(Form::date('Bazaar_DateStart',null,array('class'=>'form-control'))); ?>

                      </div>
                      <div class="form-group">
                        <label> BAZAAR ENDING DATE: </label>
                        <?php echo e(Form::date('Bazaar_DateEnd',null,array('class'=>'form-control'))); ?>

                      </div>
                      <div class = "form-group">
                        <label> BAZAAR STARTING TIME: </label>
                        <?php echo e(Form::time('Bazaar_TimeStart',null,array('class'=>'form-control'))); ?>

                      </div>
                      <div class="form-group">
                        <label> BAZAAR ENDING TIME: </label>
                        <?php echo e(Form::time('Bazaar_TimeEnd',null,array('class'=>'form-control'))); ?>

                      </div>

                      <div class = "form-group">
                        <label> BAZAAR VENUE: </label>
                        <?php echo e(Form::select('Bazaar_Venue',array('WorldTradeCenter' => 'World Trade Center','MegatradeHall'=> 'Mega Trade Hall'),null,array('class'=>'form-control'))); ?>
                      ...
                      <div class = "form-group">
                        ...
                        <?php echo e(Form::file('Bazaar_EventPoster',null,array('class'=>'form-control'))); ?>
    ...
    $(document).ready(function(){
        ...
        <?php if($SucessAlert=='Bazaar Created'): ?>
            <script type= "text/javascript">
