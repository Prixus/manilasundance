  ...
  <div class="container-fluid">
      <div class="row">
        ...
        <div>
          ...
          <h3 style = "float: right">Date: {{$dategenerated}}</h3><br>
          ...
          <br>
          <h3>OR Number: {{$ReservationAccountBrandInformations->PK_PaymentID}}</h3>
              ...
              <table class="table table-striped" style = "width:100%; border-top:3px solid #3CE1E0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td></td>
                    <td>Total Cost: </td>
                    <td style="font-weight: bold;">{{$ReservationAccountBrandInformations->Billing_SubTotal}}</td> 
                  </tr>   
                  <tr>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td>VAT:</td>
                    <td style="font-weight: bold;"> {{$ReservationAccountBrandInformations->Billing_SubTotal * 0.12}}</td> 
                  </tr>
                  <tr>
                    <td></td>
                    <td></td>
                    ...
                    <td style="font-weight: bold;"> {{$ReservationAccountBrandInformations->Billing_AmountPaid  - $ReservationAccountBrandInformations->Payment_Amount}}</td> 
                  </tr>   
                  <tr>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td>Amount Paid:</td>
                    <td style="font-weight: bold;"> {{$ReservationAccountBrandInformations->Payment_Amount}}</td> 
                  </tr>   
                  <tr>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td>Balance:</td>
                    <td style="font-weight: bold;"> {{$ReservationAccountBrandInformations->Billing_AmountToBePaid}}</td>
                  </tr>              
                </tbody>
              </table>
            </div>
