...
Route::get('/admin/detailedrevenue/print', 'adminReportController@printrevenuereport');
Route::get('/admin/detailedreservations/print', 'adminReportController@printreservationreport');
Route::get('/admin/detailedrevenue/print', 'adminReportController@printrevenuereport');
Route::get('/admin/detailedregistrations/print', 'adminReportController@printregistrationreport');
